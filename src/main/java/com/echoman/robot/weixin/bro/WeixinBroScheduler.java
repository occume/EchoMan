...
public class WeixinBroScheduler {
	
	private final static Logger LOG = LoggerFactory.getLogger(WeixinBroScheduler.class);
	
	private static WeixinBroScheduler scheduler = new WeixinBroScheduler();
	
	public static WeixinBroScheduler instance(){
		return scheduler;
	}
	...
	public WeixinBroRobot getCurrRobot(){
